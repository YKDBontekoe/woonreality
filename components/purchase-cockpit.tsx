...
import { ArrowRight, Check, CircleAlert, FileText, Hammer, Home, Landmark, MapPin, Pencil, PiggyBank, Plus, Search, ShieldCheck, Sparkles, WalletCards } from "lucide-react";
...
function HomeBoardCard({
  ...
  return <article className={`home-board-card fit-${fit}`}>
    <div className="home-card-top">
      ...
      <span className="match-pill">{loading ? "…" : personalFit != null ? `${personalFit.toLocaleString("nl-NL", { maximumFractionDigits: 1 })} match` : analysis ? `${analysis.overallScore.toLocaleString("nl-NL", { maximumFractionDigits: 1 })} score` : "Onderzoek"}</span>
    </div>
