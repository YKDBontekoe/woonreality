...
export function PurchaseCockpit({ initialCases = [], focusCase }: { initialCases?: CaseSummary[]; focusCase?: string }) {
  ...
  function updateNumber(key: "budget" | "monthlyPayment" | "ownFunds" | "bedrooms" | "maxCommuteMinutes", value: string) {
