...
export function ComparisonDashboard({ bagIds }: { bagIds: string[] }) {
  ...
  if (analyses.length < 2) return <main className="site-shell"><div className="container"><SiteHeader /><div className="loading-shell"><Link className="back-link" href="/"><ArrowLeft size={14} /> Terug naar zoeken</Link><h1>Kies minstens twee woningen</h1><p className="hero-copy">Voeg woningen toe met “Vergelijk” op de woningcheck.</p><Link className="primary-button" href="/">Zoek een adres</Link></div></div></main>;
