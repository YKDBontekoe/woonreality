-- Atomically merge onboarding dismiss metadata into preferences_json without
-- rewriting concurrent buyerProfile / mortgageState / compare_ids updates.
drop function if exists public.merge_profile_preferences(jsonb, jsonb, jsonb, jsonb);
...
grant execute on function public.merge_profile_preferences(jsonb, jsonb, jsonb, jsonb, jsonb) to authenticated;
