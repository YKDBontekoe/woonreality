  ...
  return (
    <PageShell current="aankoop">
      ...
      <section className="listing-intake-card">
        <h2>Chrome of Edge</h2>
        <ol className="extension-steps">
          <li>Download <a href="/extension/woonreality-funda-chrome.zip">woonreality-funda-chrome.zip</a>.</li>
      ...
      <section className="listing-intake-card">
        <h2>Firefox</h2>
        <ol className="extension-steps">
          <li>Download <a href="/extension/woonreality-funda-firefox.xpi">woonreality-funda-firefox.xpi</a>.</li>
