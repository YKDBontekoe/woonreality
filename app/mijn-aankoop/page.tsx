...
export default async function MyPurchasePage({ searchParams }: { searchParams: Promise<{ setup?: string }> }) {
  ...
  return <main className="site-shell"><div className="container purchase-page">
    ...
    <PasskeySettings email={auth.user.email ?? "Je e-mailadres"} emailConfirmed={Boolean(auth.user.email_confirmed_at)} suggestEnrollment={params.setup === "passkey"} />
